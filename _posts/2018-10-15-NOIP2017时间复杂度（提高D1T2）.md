...
string a,b;
int c,d,e,f[maxn],g[maxn],h,flag,l[maxn],m,n,T;
void Clear(){c=d=m=n=e=h=flag=0;mem(f,0);mem(l,0);}
int main(){
...
//	freopen("out.txt","w",stdout);
    ...
    while(T--){
        ...
        rep(i,0,a.length()-1)c=c*10+a[i]-'0';
        rep(i,4,b.length()-2)d=d*10+b[i]-'0';
        while(c>0){
            cin>>a;c--;
            if(a[0]=='F'){
                e++;cin>>a;
